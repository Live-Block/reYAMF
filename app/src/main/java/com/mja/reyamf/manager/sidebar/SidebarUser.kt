...
@AndroidEntryPoint
class SidebarUser() : LifecycleService() {
    companion object {
    ...
    override fun onTaskRemoved(rootIntent: Intent) {
        val restartServiceIntent = Intent(applicationContext, SidebarUser::class.java).also {
    ...
    private fun handleSidebar() {
        ...
        binding.ibAppList.setOnClickListener {
            runMain {
                startService(Intent(this@SidebarUser, AppListWindow::class.java))
            }
            hideMenu()
        }
        ...
        binding.rvSideBarMenu.layoutManager = LinearLayoutManager(this@SidebarUser)
    ...
    private fun moveSidebar(event: MotionEvent): Boolean {
        ...
        if (movable) {
            ...
            Log.d("test", config.portraitY.toString())
            Log.d("test", config.landscapeY.toString())
                    ...
                    override fun onGlobalLayout() {
                        ...
                        lifecycleScope.launch {
                            ...
                            animateResize(
                                ...
                                75.dpToPx().toInt(), 350.dpToPx().toInt(), this@SidebarUser
                            ) {
